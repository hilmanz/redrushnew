...
<?php 
		...
		
		{
			...
			<dl class="thumbnailListing" id="dl<?php echo $count; ?>">
				...
				<?php
					switch($file['cssClass'])
					{
						case 'filePicture':
								...
								/* ganti biar bisa pake subdomain buat admin
								echo '<a id="thumbUrl' . $count . '" rel="thumbPhotos" href="' . $file['path'] . '">';
								*/
								echo '<a id="thumbUrl' . $count . '" rel="thumbPhotos" href="' . $file['previewPath'] . '">';
				...
				-->
				<a <?php echo ($file['cssClass']== 'filePicture'?'rel="orgImg"':''); ?> href="<?php echo $file['previewPath']; ?>" title="<?php echo $file['name']; ?>" id="a<?php echo $count; ?>"><?php echo shortenFileName($file['name']); ?></a></dd>
