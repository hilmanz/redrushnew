...
<div id="body">
    <div id="top">
        ...
        <div id="topmenu">
            <ul>
                ...
                <li><span><a><strong>Loged in user : </strong><?php echo $this->_tpl_vars['user']['username']; ?>
</a></span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="nav">
		...
		<ul class="menu" id="menu">
            ...
            <li><a href="index.php?s=pages">Pages</a></li>
            <li><a href="#">News</a>
            	<ul>
                	<li><a href="index.php?s=news">List News</a></li>
                                       <li><a href="index.php?s=news&act=add">Add New</a></li>
                </ul>
            </li>
            <li><a href="#">Message</a>
            	<ul>
                	<li><a href="index.php?s=message">Send to single user</a></li>
                    <li><a href="index.php?s=message&act=mass">Send to all users</a></li>
                </ul>
            </li>
            <li><a href="#">Management</a>
                <ul>
                	<li><a href="#">Merchandise</a>
            			<ul>
                            <li><a href="index.php?s=merchandise&act=add">Add New Merchandise</a></li>
                            <li><a href="index.php?s=merchandise">List Merchandise</a></li>
                            <li><a href="index.php?s=merchandise&act=purchase-list">List Puchase Merchandise</a></li>
                        </ul>
            		</li>
                	<li><a href="#">Ultimate Car</a>
            			<ul>
                            <li><a href="index.php?s=ultimate-car&act=add">Add</a></li>
                            <li><a href="index.php?s=ultimate-car">List</a></li>
                        </ul>
            		</li>
                    <li><a href="#">Player Management</a>
            			<ul>
                            <li><a href="index.php?s=player">Player Avatar</a></li>
                        </ul>
            		</li>
                </ul>
            </li>
