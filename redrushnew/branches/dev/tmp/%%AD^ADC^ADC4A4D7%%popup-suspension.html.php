...
" alt="" />
                            <?php if ($this->_tpl_vars['parts']['suspensions'][$this->_sections['i']['index']]->level > $this->_tpl_vars['level']): ?><img src="img/part_lock.png" class="partlock" /><?php endif; ?>
...
?>
                                                      <?php if ($this->_tpl_vars['parts']['suspensions'][$this->_sections['i']['index']]->level == $this->_tpl_vars['cek_winning_ultimate_car'][$this->_sections['c']['index']]->level+1): ?>
