						...
						<?php
							...
							foreach($fileList as $file)
							{
								...
								<tr class="<?php echo $css; ?>" id="row<?php echo $count; ?>"  >
									...
									<!-- Ganti biar bisa support subdomain buat admin
									...
									-->
									<td align="center" class="fileColumns" id="tdst<?php echo $count; ?>">&nbsp;<a id="a<?php echo $count; ?>" href="<?php echo $file['previewPath']; ?>" target="_blank"><span class="<?php echo $file['cssClass']; ?>">&nbsp;</span></a></td>
									<td class="<?php echo $strClass; ?> docName"  id="tdnd<?php echo $count; ?>"><a id="a<?php echo $count; ?>" href="<?php echo $file['previewPath']; ?>"><?php echo $file['name']; ?></a></td>
