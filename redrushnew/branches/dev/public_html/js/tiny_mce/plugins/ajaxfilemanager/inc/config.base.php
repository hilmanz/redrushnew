...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../public_html/contents/uploads/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../public_html/contents/uploads/');	//accept relative path only
	...
	define('CONFIG_WEBSITE_HTTP_SERVER', 'http://kanacms.loc');	//Ganti dengan url frontend
